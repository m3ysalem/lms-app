  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden md:flex w-1/2 bg-ink-800 text-white flex-col justify-between p-12">
        ...
        <p className="text-white/40 text-sm">© {new Date().getFullYear()} Meridian Learning &amp; Development</p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <form onSubmit={handleSubmit} className="w-full max-w-sm">
          ...
          <div className="flex items-center justify-between mb-5">
            ...
            <a href="#" className="text-sm text-teal hover:underline" onClick={(e) => { e.preventDefault(); alert('Ask your HR/L&D admin to reset your password from the Employees page.') }}>
              Forgot password?
            </a>
          </div>
