  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!rawInput.includes('@')) {
        ...
        if (rpcErr || !emailData) {
          setBusy(false)
          setError('كود الموظف غير مسجل أو لم تقم بتنفيذ دالة الـ RPC في Supabase.')
          return
        }
        loginIdentifier = emailData.trim()
      }

      // تنبيه مؤكد يوضح لك ما إذا تم تحويل الكود إلى الإيميل الصحيح أم لا
      alert("القيمة المرسلة لـ Supabase هي: " + loginIdentifier);
