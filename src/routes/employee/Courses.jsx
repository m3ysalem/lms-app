...
export default function Dashboard() {
  ...
  // جعلنا القيمة الابتدائية مصفوفة فاضية بدل null عشان اللودينج ما يعلقش أبداً
  ...
  useEffect(() => {
    // لو مفيش بروفايل، نوقف اللودينج ونعدي فوراً بدل التعليق
    if (!profile?.id) {
  ...
  if (loadingData && !assignments.length) return <Spinner />
